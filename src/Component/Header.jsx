...
export default function Header() {
  return (
    <header className="px-5 py-3 flex flex-col  justify-between items-center md:flex md:justify-between md:items-center lg:px-20 lg:py-3">
      {/* Logo */}
      ...
      <nav >
        <div className="absolute top-20 left-5 flex flex-col gap-5 lg:flex lg:gap-15 lg:text-zinc-700 ">
