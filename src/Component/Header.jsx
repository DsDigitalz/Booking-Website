      ...
      <nav>
        ...
        >
          ...
          <ul className="flex  flex-col gap-10 lg:flex-row  lg:gap-10  ">
            <li className=" text-lg cursor-pointer active:bg-black active:text-white active:rounded  px-2 py-1 lg:hover:text-black lg:active:text-zinc-400 lg:active:bg-transparent    hover:scale-107 transition-all duration-300 lg:text-[16px]">
              Home
            </li>
            <li className="text-lg active:rounded  px-2 py-1  active:bg-black lg:active:bg-transparent  active:text-white  cursor-pointer hover:scale-105 lg:active:text-zinc-400 hover:text-black scale:text-[18px] transition-all duration-300 lg:text-[16px] ">
              Landlords
            </li>
            <li className="text-lg active:rounded  px-2 py-1  lg:active:bg-transparent active:bg-black active:text-white  cursor-pointer  hover:scale-107 hover:text-black scale:text-[18px]  transition-all duration-300 lg:text-[16px] lg:active:text-zinc-400">
              Erasmus Life
            </li>
            <li className=" text-lg active:rounded  px-2 py-1  lg:active:bg-transparent  active:text-white  cursor-pointer  active:bg-black hover:scale-107 hover:text-black scale:text-[18px] transition-all duration-300 lg:text-[16px] lg:active:text-zinc-400">
              About Us
            </li>
          </ul>
          <div className="text-lg lg:text-zinc-700 lg:flex  lg:active:bg-transparent lg:gap-10 lg:items-center">
            ...
            <button className="text-lg mt-7 cursor-pointer active:bg-zinc-400 rounded-lg border border-zinc-400 px-3 py-2 text-[16px] font-semibold hover:bg-black  hover:text-white transition-all duration-500 lg:mt-0 lg:text-[16px] lg:active:text-zinc-400">
              Rent a Room
            </button>
          </div>
        </div>
